<template>
  ...
  <Popover as="template" v-slot="{ open }">
    <header
      :class="[open ? 'fixed inset-0 z-40 overflow-y-auto' : '', 'fixed top-0 left-0 w-screen bg-white shadow-sm lg:overflow-y-visible']"
    >
      <div class="mx-auto max-w-7xl px-8 sm:px-6 lg:px-10">
